    ...
    <div class="container">
        ...
        <div class="justify-content-center">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::model($user, ['route' => ['admin.users.update', $user->id], 'method' => 'PATCH', 'enctype' => 'multipart/form-data', 'id' => 'upload']) !!}
                    ...
                    <div class="col-md-12" id="NewClass">
                        <div class="form-group">
                            ...
                            @else
                                <div id="post_select_image_container" class="post-select-image-container">
                                    <img src="{{ asset('images/profile/profile-image.png') }}" width="170px"
