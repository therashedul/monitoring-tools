                ...
                <div class="x_content">
                    <form method="POST" action="{{ route('activation.store') }}">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <select name="service_id" class="form-control">
                                    ...
                                    @foreach ($activations as $service)
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input type="number" name="activation" class="form-control" required="required">
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input type="number" name="deactivation" class="form-control" required="required">
                            </div>
                        </div>
                        <div class="item form-group">
